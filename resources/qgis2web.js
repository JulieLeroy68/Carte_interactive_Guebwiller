...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            extent: [-364146687.373655, -352011635.168134, 365191229.285904, 239494000.477685],
            units: 'm'})
    })
});
...
map.getView().fit([1010502.908387, 6764990.354604, 1015295.302811, 6768127.730566], map.getSize());
